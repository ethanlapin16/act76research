...
****
drdid `y_var' $covs_main if inlist(year, 2021, 2022) [iw=perwt], time(year) tr(Treat) drimp
...
drdid `y_var' $covs_sm if inlist(year, 2021, 2022) [iw=perwt], time(year) tr(Treat) drimp
estimates store DR4
restore
